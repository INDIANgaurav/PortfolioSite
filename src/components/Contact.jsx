  ...
  return (
    ...
    <div className='dark:bg-black dark:text-white py-14 '>
        <div className='container'>
            <div className='grid grid-cols-1 sm:grid-cols-3 gaps-6 bg-dark py-8 px-6 '>
                <div className='col-span-2 space-y-3'>
                    <h1 className='text-5xl font-bold text-white '>Let's work together on your next project</h1>
                    <p className='text-gray-400'>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Laudantium accusantium reiciendis dicta, ea consequuntur nemo placeat 
                    </p>
                </div>
